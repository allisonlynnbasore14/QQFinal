...
function StoreScoreData(status, id, numberC){
  ...
  console.log(score, total, numberC)
  if (total.toString() === numberC.toString()){
...
var DRulesQ = function(req, res){
    res.render("DRulesQ",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.DRU + ' XII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var DRulesCopy = function(req, res){
  res.render("DRulesCopy",{"directions": constants.DIR.COPY, "title": constants.TITLE.DRU + ' XII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var DRulesQ2 = function(req, res){
  res.render("DRulesQ2",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.DRU + ' XIV', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

/////////////////////////////Prime Numbers
var PrimeNumbers = function(req, res){
  res.render("PrimeNumbers",{"directions": constants.DIR.CLICK_PRIME, "title": constants.TITLE.PIN + ' XV', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var PrimeNumbersCopy = function(req, res){
  res.render("PrimeNumbersCopy",{"directions": constants.DIR.COPY, "title": constants.TITLE.PIN + ' XVI', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var PrimeNumbersQ = function(req, res){
  res.render("PrimeNumbersQ",{"directions": constants.DIR.COMP_PRIME, "title": constants.TITLE.PIN + ' XVII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var PrimeNumbersQ2 = function(req, res){
  res.render("PrimeNumbersQ2",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.PIN + ' XVIII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var PrimeNumbersList = function(req, res){
  res.render("PrimeNumbersList",{"directions": constants.DIR.LIST_PRIME, "title": constants.TITLE.PIN + ' XIX', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

/////////////////////////////Square Numbers
var SquareNumbersMatch = function(req, res){
  res.render("SquareNumbersMatch",{"directions": constants.DIR.MATCH, "title": constants.TITLE.SQU + ' XXXII' , "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};
...
var SquareTF = function(req, res){
  res.render("SquareTF",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.SQU + ' XXXIV', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var SquareNumbersQ = function(req, res){
  res.render("SquareNumbersQ",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.SQU + ' XXXV', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var SquareNumbersList = function(req, res){
  res.render("SquareNumbersList",{"directions": constants.DIR.LIST_SQUARE_NUMBERS, "title": constants.TITLE.SQU + ' XXXVI', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

/////////////////////////////PTheorem
var PTheoremCopy = function(req, res){
  res.render("PTheoremCopy",{"directions": constants.DIR.COPY, "title": constants.TITLE.PTH + ' XXXVII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var PTheoremQ = function(req, res){
  res.render("PTheoremQ",{"directions": constants.DIR.PICTURE, "title": constants.TITLE.PTH + ' XXXVIII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var PTheoremFill = function(req, res){
  res.render("PTheoremFill",{"directions": constants.DIR.FILL, "title": constants.TITLE.PTH + ' XXXIX', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

/////////////////////////////Props

var PropsStudy = function(req, res){
  res.render("PropsStudy",{"directions": constants.DIR.STUDY, "title": constants.TITLE.PRO + ' VI', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var PropsQ = function(req, res){
  res.render("PropsQ",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.PRO + ' VII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};
...
var PropsQ3 = function(req, res){
  res.render("PropsQ3",{"directions": constants.DIR.PROPERTY, "title": constants.TITLE.PRO + ' X', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

/////////////////////////////Angles

var AnglesStudy = function(req, res){
  res.render("AnglesStudy",{"directions": constants.DIR.STUDY, "title": constants.TITLE.ANG + ' XL', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var AnglesQ = function(req, res){
  res.render("AnglesQ",{"directions": constants.DIR.PROPERTY, "title": constants.TITLE.ANG + ' XLI', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var AnglesMatch = function(req, res){
  res.render("AnglesMatch",{"directions": constants.DIR.MATCH, "title": constants.TITLE.ANG + ' XLII' , "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var AnglesQ2 = function(req, res){
  res.render("AnglesQ2",{"directions": constants.DIR.ANGLE, "title": constants.TITLE.ANG + ' XLIII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var AnglesQ3 = function(req, res){
  res.render("AnglesQ3",{"directions": constants.DIR.ANGLE, "title": constants.TITLE.ANG + ' XLIV', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};
...
var ProbStudy = function(req, res){
  res.render("ProbStudy",{"directions": constants.DIR.STUDY, "title": constants.TITLE.PRB + ' XLVI', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var ProbQ = function(req, res){
  res.render("ProbQ",{"directions": constants.DIR.FILL, "title": constants.TITLE.PRB + ' XLVII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var ProbQ2 = function(req, res){
  res.render("ProbQ2",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.PRB + ' XLVIII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var ProbTF = function(req, res){
  res.render("ProbTF",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.PRB + ' XLIX', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var ProbQ3 = function(req, res){
  res.render("ProbQ3",{"directions": constants.DIR.DICE, "title": constants.TITLE.PRB + ' L', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};
...
var FractionStudy = function(req, res){
  res.render("FractionStudy",{"directions": constants.DIR.STUDY, "title": constants.TITLE.FRA + ' XXV', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var FractionGCFQ = function(req, res){
  res.render("FractionGCFQ",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.FRA + ' XXVI', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var FractionLCMQ = function(req, res){
  res.render("FractionLCMQ",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.FRA + ' XXVII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var FractionImpQ= function(req, res){
  res.render("FractionImpQ", {"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.FRA + ' XXVIII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var FractionQ= function(req, res){
  res.render("FractionQ", {"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.FRA + ' XXIX', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var FractionQ2 = function(req, res){
  res.render("FractionQ2",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.FRA + ' XXX', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

/////////////////////////////Sequences

var SequenceStudy = function(req, res){
  res.render("SequenceStudy",{"directions": constants.DIR.STUDY, "title": constants.TITLE.SEQ + ' LI', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var SequenceQ = function(req, res){
  res.render("SequenceQ",{"directions": constants.DIR.SEQUENCE, "title": constants.TITLE.SEQ + ' LII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var SequenceQ2 = function(req, res){
  res.render("SequenceQ2",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.SEQ + ' LIII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

/////////////////////////////Exponents

var ExponentStudy = function(req, res){
  res.render("ExponentStudy",{"directions": constants.DIR.STUDY, "title": constants.TITLE.EXP + ' XX', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var ExponentQ = function(req, res){
  res.render("ExponentQ",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.EXP + ' XXI', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var ExponentQ2 = function(req, res){
  res.render("ExponentQ2",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.EXP + ' XXII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var ExponentQ3 = function(req, res){
  res.render("ExponentQ3",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.EXP + ' XXIII', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};

var ExponentQ4 = function(req, res){
  res.render("ExponentQ4",{"directions": constants.DIR.ANSWERQ, "title": constants.TITLE.EXP + ' XXIV', "show":false,  "numberC" : 0, "missedQ":0, "id" : req.params.id, "status":req.params.status});
};
